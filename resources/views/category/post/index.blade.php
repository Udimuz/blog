...
<main class="blog">
    <div class="container">
        <h1 class="text-center mt-3 mb-5">Блог</h1>
        <h2 class="text-center mb-5">Категории</h2>
        <h3 class="text-center mb-5">{{ $category->title }}</h3>
        <section class="featured-posts-section">
            <div class="row">
                @foreach($posts as $post)
                <div class="col-md-4 fetured-post blog-post" data-aos="fade-up">
                    <div class="blog-post-thumbnail-wrapper"><img src="{{ asset('storage/'.$post->preview_image) }}" alt="blog post"></div>
